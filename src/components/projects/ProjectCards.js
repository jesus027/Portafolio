...
const ProjectCards = ({ title, des, src, git, ver, }) => {
    return (
        <div className='w-full p-4 xl:px-12 h-auto xl:py-10 rounded-lg shadow-shadowOne flex flex-col bg-gradient-to-r
        from-bodyColor top-[#202327] group hover:bg-gradient-to-b hover:from-gray-900 hover:gray-900
                ...
                <div>
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='flex gap-4'>
                            ...
                            <a href={ver} rel='noopener noreferrer' target='_blank'>
                                <span className='text-lg w-10 h-10 rounded-full bg-black inline-flex justify-center
                                items-center text-gray-400 hover:text-designColor duration-300 cursor-pointer'>
                                    <BsGlobe />
                                </span>
