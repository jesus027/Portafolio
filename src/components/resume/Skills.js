        ...
        >
            <div className='w-full lgl:w-1/2'>
                <div className='py-12 font-titleFont flex flex-col gap-4'>
                    <p className='text-sm text-designColor tracking-[4px] uppercase'>Características</p>
                    <h2 className='text-3xl lgl:text-4xl font-bold'>Habilidad de Front-End</h2>
                </div>
                    ...
                    <div className='overflow-x-hidden'>
                        ...
                        <span className='w-full h-2 bgOpacity inline-flex rounded-md mt-2'>
                            <motion.span
                                ...
                                animate={{ x: 0 , opacity: 1 }}
                                transition={{ duration: 0.5 , delay: 0.5 }}
                                className='w-[55%] h-full bg-gradient-to-r from-blue-600 via-lime-500
                            to-yellow-500 rounded-md relative'
                            >
                    ...
                    <div className='overflow-x-hidden'>
                        ...
                        <span className='w-full h-2 bgOpacity inline-flex rounded-md mt-2'>
                            <motion.span
                                ...
                                animate={{ x: 0 , opacity: 1 }}
                                transition={{ duration: 0.5 , delay: 0.5 }}
                                className='w-[70%] h-full bg-gradient-to-r from-blue-600 via-lime-500
                            to-yellow-500 rounded-md relative'
                            >
            ...
            <div className='w-full lgl:w-1/2'>
                <div className='py-12 font-titleFont flex flex-col gap-4'>
                    <p className='text-sm text-designColor tracking-[4px] uppercase'>Características</p>
                    <h2 className='text-3xl lgl:text-4xl font-bold'>Habilidad de Back-End</h2>
                </div>
                    ...
                    <div className='overflow-x-hidden'>
                        ...
                        <span className='w-full h-2 bgOpacity inline-flex rounded-md mt-2'>
                            <motion.span
                                ...
                                animate={{ x: 0 , opacity: 1 }}
                                transition={{ duration: 0.5 , delay: 0.5 }}
                                className='w-[15%] h-full bg-gradient-to-r from-blue-600 via-lime-500
                            to-yellow-500 rounded-md relative'
                            >
